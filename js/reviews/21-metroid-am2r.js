window.CHRONIQUES.push({
  ...
  review: [
    ...
    "Avec des graphismes inspirés des versions GBA, des musiques technoîdes qui collent bien à l'ambiance et des petits rajouts bien trouvés, on aurait difficilement pu faire mieux étant donné le matériau de base.",
    "Nintendo a sorti quelques temps après <em>Samus Returns</em>, son remake officiel de sur 3DS. Je n'y ai pas joué, donc je ne pourrais pas donner d'avis dessus, mais, comme je le disais avant, je préfère personnellement une jolie 2D qu'une 2,5D bien polygonale.",
