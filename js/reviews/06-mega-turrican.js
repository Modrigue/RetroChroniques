window.CHRONIQUES.push({
  ...
  nbPlayers: 1,
  review: [
    "<em>Turrican 1 & 2</em> étaient parmi les meilleurs jeux d'action sur ordi début 90, sorte de version arcade de Metroid. Une saga pionnière du style run'n'gun, dotée d'un style visuel SF soigné, inspiré d'H.R. Giger (design des films <em>Alien</em>), et des musiques superbes. Le joueur est encouragé à explorer des niveaux gigantesques, avec un nb. d'écrans record pour l'époque. C'est aussi la 1ère fois où j'ai vu des boss de débuts/milieu de niveau, des sorties en haut/en bas, aux lieux des classiques \"boss de fin de niveau tout à droite\".",
